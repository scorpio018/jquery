...
var _4b0=0;
var _4b1=0;
_4af.children().each(function(){
var c=$(this);
if(c.is(":visible")){
_4b0+=c._outerHeight();
if(_4b1<c._outerWidth()){
_4b1=c._outerWidth();
}
}
});
...
tr1.css("height","");
tr2.css("height","");
var _4b2=Math.max(tr1.height(),tr2.height());
tr1.css("height",_4b2);
tr2.css("height",_4b2);
}
};
...
function _4b7(_4b8){
var _4b9=_4b8?1:2;
var tr=opts.finder.getTr(_4b4,_4b5,"body",_4b9);
(_4b8?dc.body1:dc.body2).children("table.datagrid-btable-frozen").append(tr);
};
};
...
var _4be=[];
var _4bf=[];
$(_4bb).children("thead").each(function(){
...
opt.frozen?_4be.push(cols):_4bf.push(cols);
});
});
return [_4be,_4bf];
};
var _4c0=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_4bb);
_4c0.panel({doSize:false});
_4c0.panel("panel").addClass("datagrid").bind("_resize",function(e,_4c1){
var opts=$.data(_4bb,"datagrid").options;
if(opts.fit==true||_4c1){
_498(_4bb);
setTimeout(function(){
if($.data(_4bb,"datagrid")){
_4c2(_4bb);
}
},0);
}
...
$(_4bb).hide().appendTo(_4c0.children("div.datagrid-view"));
var cc=_4bd();
var view=_4c0.children("div.datagrid-view");
var _4c3=view.children("div.datagrid-view1");
var _4c4=view.children("div.datagrid-view2");
var _4c5=_4c0.closest("div.datagrid-view");
if(!_4c5.length){
_4c5=view;
}
var ss=_48b(_4c5);
return {panel:_4c0,frozenColumns:cc[0],columns:cc[1],dc:{view:view,view1:_4c3,view2:_4c4,header1:_4c3.children("div.datagrid-header").children("div.datagrid-header-inner"),header2:_4c4.children("div.datagrid-header").children("div.datagrid-header-inner"),body1:_4c3.children("div.datagrid-body").children("div.datagrid-body-inner"),body2:_4c4.children("div.datagrid-body"),footer1:_4c3.children("div.datagrid-footer").children("div.datagrid-footer-inner"),footer2:_4c4.children("div.datagrid-footer").children("div.datagrid-footer-inner")},ss:ss};
};
function _4c6(_4c7){
var _4c8=$.data(_4c7,"datagrid");
var opts=_4c8.options;
var dc=_4c8.dc;
var _4c9=_4c8.panel;
_4c9.panel($.extend({},opts,{id:null,doSize:false,onResize:function(_4ca,_4cb){
setTimeout(function(){
if($.data(_4c7,"datagrid")){
_49c(_4c7);
_4ec(_4c7);
opts.onResize.call(_4c9,_4ca,_4cb);
}
},0);
},onExpand:function(){
_4a9(_4c7);
opts.onExpand.call(_4c9);
}}));
_4c8.rowIdPrefix="datagrid-row-r"+(++_486);
_4c8.cellClassPrefix="datagrid-cell-c"+_486;
_4cc(dc.header1,opts.frozenColumns,true);
_4cc(dc.header2,opts.columns,false);
_4cd();
dc.header1.add(dc.header2).css("display",opts.showHeader?"block":"none");
dc.footer1.add(dc.footer2).css("display",opts.showFooter?"block":"none");
if(opts.toolbar){
if(typeof opts.toolbar=="string"){
$(opts.toolbar).addClass("datagrid-toolbar").prependTo(_4c9);
$(opts.toolbar).show();
}else{
$("div.datagrid-toolbar",_4c9).remove();
var tb=$("<div class=\"datagrid-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").prependTo(_4c9);
var tr=tb.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
...
$("div.datagrid-pager",_4c9).remove();
if(opts.pagination){
var _4ce=$("<div class=\"datagrid-pager\"></div>");
if(opts.pagePosition=="bottom"){
_4ce.appendTo(_4c9);
}else{
if(opts.pagePosition=="top"){
_4ce.addClass("datagrid-pager-top").prependTo(_4c9);
}else{
var ptop=$("<div class=\"datagrid-pager datagrid-pager-top\"></div>").prependTo(_4c9);
_4ce.appendTo(_4c9);
_4ce=_4ce.add(ptop);
}
}
_4ce.pagination({total:0,pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_4cf,_4d0){
opts.pageNumber=_4cf;
opts.pageSize=_4d0;
_4ce.pagination("refresh",{pageNumber:_4cf,pageSize:_4d0});
_5b1(_4c7);
}});
opts.pageSize=_4ce.pagination("options").pageSize;
}
function _4cc(_4d1,_4d2,_4d3){
if(!_4d2){
return;
}
$(_4d1).show();
$(_4d1).empty();
var t=$("<table class=\"datagrid-htable\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody></tbody></table>").appendTo(_4d1);
...
col.cellClass=_4c8.cellClassPrefix+"-"+col.field.replace(/[\.|\s]/g,"-");
}else{
...
function _4cd(){
var _4d4=[];
var _4d5=_4d6(_4c7,true).concat(_4d6(_4c7));
for(var i=0;i<_4d5.length;i++){
var col=_4d7(_4c7,_4d5[i]);
if(col&&!col.checkbox){
_4d4.push(["."+col.cellClass,col.boxWidth?col.boxWidth+"px":"auto"]);
}
}
_4c8.ss.add(_4d4);
_4c8.ss.dirty(_4c8.cellSelectorPrefix);
_4c8.cellSelectorPrefix="."+_4c8.cellClassPrefix;
};
};
function _4d8(_4d9){
...
var dc=_4da.dc;
var _4dc=dc.header1.add(dc.header2);
_4dc.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",function(e){
...
var _4dd=_4dc.find("div.datagrid-cell");
_4dd.closest("td").unbind(".datagrid").bind("mouseenter.datagrid",function(){
if(_4da.resizing){
return;
}
...
var _4de=$(this).attr("field");
opts.onHeaderContextMenu.call(_4d9,e,_4de);
});
_4dd.unbind(".datagrid").bind("click.datagrid",function(e){
var p1=$(this).offset().left+5;
var p2=$(this).offset().left+$(this)._outerWidth()-5;
if(e.pageX<p2&&e.pageX>p1){
var _4df=$(this).parent().attr("field");
var col=_4d7(_4d9,_4df);
if(!col.sortable||_4da.resizing){
return;
}
opts.sortName=_4df;
...
_4dd.removeClass("datagrid-sort-asc datagrid-sort-desc");
$(this).addClass(cls);
if(opts.remoteSort){
_5b1(_4d9);
}else{
var data=$.data(_4d9,"datagrid").data;
_518(_4d9,data);
}
opts.onSortColumn.call(_4d9,opts.sortName,opts.sortOrder);
}
...
var col=_4d7(_4d9,_4e0);
if(col.resizable==false){
return;
}
$(_4d9).datagrid("autoSizeColumn",_4e0);
col.auto=false;
}
});
var _4e1=opts.resizeHandle=="right"?"e":(opts.resizeHandle=="left"?"w":"e,w");
_4dd.each(function(){
$(this).resizable({handles:_4e1,disabled:($(this).attr("resizable")?$(this).attr("resizable")=="false":false),minWidth:25,onStartResize:function(e){
_4da.resizing=true;
_4dc.css("cursor",$("body").css("cursor"));
if(!_4da.proxy){
_4da.proxy=$("<div class=\"datagrid-resize-proxy\"></div>").appendTo(dc.view);
}
_4da.proxy.css({left:e.pageX-$(_4db).offset().left-1,display:"none"});
setTimeout(function(){
if(_4da.proxy){
_4da.proxy.show();
}
...
_4da.proxy.css({left:e.pageX-$(_4db).offset().left-1,display:"block"});
return false;
},onStopResize:function(e){
_4dc.css("cursor","");
var _4e2=$(this).parent().attr("field");
var col=_4d7(_4d9,_4e2);
...
_4ec(_4d9);
opts.onResizeColumn.call(_4d9,_4e2,col.width);
setTimeout(function(){
_4da.resizing=false;
},0);
}});
...
var _4e4=_4e5(tr);
opts.finder.getTr(_4d9,null,"highlight").removeClass("datagrid-row-over");
opts.finder.getTr(_4d9,_4e4).addClass("datagrid-row-over");
e.stopPropagation();
}).bind("mouseout",function(e){
var tr=$(e.target).closest("tr.datagrid-row");
if(!_4e3(tr)){
...
var _4e6=_4e5(tr);
opts.finder.getTr(_4d9,_4e6).removeClass("datagrid-row-over");
e.stopPropagation();
}).bind("click",function(e){
var tt=$(e.target);
...
var row=opts.finder.getRow(_4d9,_4e7);
var td=tt.closest("td[field]",tr);
if(td.length){
var _4e8=td.attr("field");
opts.onClickCell.call(_4d9,_4e7,_4e8,row[_4e8]);
}
...
opts.onClickRow.call(_4d9,_4e7,row);
}
e.stopPropagation();
}).bind("dblclick",function(e){
var tt=$(e.target);
...
var _4e9=_4e5(tr);
var row=opts.finder.getRow(_4d9,_4e9);
var td=tt.closest("td[field]",tr);
if(td.length){
var _4ea=td.attr("field");
opts.onDblClickCell.call(_4d9,_4e9,_4ea,row[_4ea]);
}
opts.onDblClickRow.call(_4d9,_4e9,row);
e.stopPropagation();
}).bind("contextmenu",function(e){
var tr=$(e.target).closest("tr.datagrid-row");
if(!_4e3(tr)){
...
var _4eb=_4e5(tr);
var row=opts.finder.getRow(_4d9,_4eb);
opts.onRowContextMenu.call(_4d9,e,_4eb,row);
e.stopPropagation();
});
...
var _4ee=dc.view2.children("div.datagrid-header");
var _4ef=0;
var _4f0;
var _4f1=_4d6(_4ed,false);
for(var i=0;i<_4f1.length;i++){
var col=_4d7(_4ed,_4f1[i]);
if(_4f2(col)){
_4ef+=col.width;
_4f0=col;
}
}
var _4f3=_4ee.children("div.datagrid-header-inner").show();
var _4f4=_4ee.width()-_4ee.find("table").width()-opts.scrollbarSize;
var rate=_4f4/_4ef;
if(!opts.showHeader){
_4f3.hide();
}
...
var col=_4d7(_4ed,_4f1[i]);
if(_4f2(col)){
var _4f5=Math.floor(col.width*rate);
_4f6(col,_4f5);
_4f4-=_4f5;
}
}
...
_4c2(_4ed);
function _4f6(col,_4f7){
col.width+=_4f7;
col.boxWidth+=_4f7;
_4ee.find("td[field=\""+col.field+"\"] div.datagrid-cell").width(col.boxWidth);
};
function _4f2(col){
...
var _4fb=false;
var _4fc=_4d6(_4f9,true).concat(_4d6(_4f9,false));
for(var i=0;i<_4fc.length;i++){
var _4fa=_4fc[i];
var col=_4d7(_4f9,_4fa);
if(col.auto){
_498(_4fa);
_4fb=true;
}
}
if(_4fb&&opts.fitColumns){
_49c(_4f9);
_4ec(_4f9);
}
}
function _498(_4fd){
var _4fe=dc.view.find("div.datagrid-header td[field=\""+_4fd+"\"] div.datagrid-cell");
_4fe.css("width","");
var col=$(_4f9).datagrid("getColumnOption",_4fd);
col.width=undefined;
col.boxWidth=undefined;
col.auto=true;
$(_4f9).datagrid("fixColumnSize",_4fd);
var _4ff=Math.max(_4fe._outerWidth(),_500("allbody"),_500("allfooter"));
_4fe._outerWidth(_4ff);
col.width=_4ff;
col.boxWidth=parseInt(_4fe[0].style.width);
$(_4f9).datagrid("fixColumnSize",_4fd);
opts.onResizeColumn.call(_4f9,_4fd,col.width);
function _500(type){
var _501=0;
opts.finder.getTr(_4f9,0,type).find("td[field=\""+_4fd+"\"] div.datagrid-cell").each(function(){
...
function _4c2(_502,_503){
var _504=$.data(_502,"datagrid");
var opts=_504.options;
var dc=_504.dc;
var _505=dc.view.find("table.datagrid-btable,table.datagrid-ftable");
_505.css("table-layout","fixed");
if(_503){
fix(_503);
}else{
var ff=_4d6(_502,true).concat(_4d6(_502,false));
for(var i=0;i<ff.length;i++){
fix(ff[i]);
}
}
_505.css("table-layout","auto");
_506(_502);
setTimeout(function(){
_4a9(_502);
_50b(_502);
...
function fix(_507){
var col=_4d7(_502,_507);
if(!col.checkbox){
_504.ss.set("."+col.cellClass,col.boxWidth?col.boxWidth+"px":"auto");
}
};
};
function _506(_508){
...
var td=$(this);
var _509=td.attr("colspan")||1;
var _50a=_4d7(_508,td.attr("field")).width;
for(var i=1;i<_509;i++){
td=td.next();
_50a+=_4d7(_508,td.attr("field")).width+1;
}
$(this).children("div.datagrid-cell")._outerWidth(_50a);
});
};
function _50b(_50c){
var dc=$.data(_50c,"datagrid").dc;
dc.view.find("div.datagrid-editable").each(function(){
var cell=$(this);
var _50d=cell.parent().attr("field");
var col=$(_50c).datagrid("getColumnOption",_50d);
cell._outerWidth(col.width);
...
function _4d6(_511,_512){
var opts=$.data(_511,"datagrid").options;
var _513=(_512==true)?(opts.frozenColumns||[[]]):opts.columns;
if(_513.length==0){
return [];
}
var _514=[];
...
function _518(_519,data){
var _51a=$.data(_519,"datagrid");
var opts=_51a.options;
var dc=_51a.dc;
data=opts.loadFilter.call(_519,data);
data.total=parseInt(data.total);
_51a.data=data;
if(data.footer){
_51a.footer=data.footer;
}
if(!opts.remoteSort){
var opt=_4d7(_519,opts.sortName);
if(opt){
var _51b=opt.sorter||function(a,b){
return (a>b?1:-1);
};
data.rows.sort(function(r1,r2){
return _51b(r1[opts.sortName],r2[opts.sortName])*(opts.sortOrder=="asc"?1:-1);
});
}
}
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_519,data.rows);
}
opts.view.render.call(opts.view,_519,dc.body2,false);
opts.view.render.call(opts.view,_519,dc.body1,true);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_519,dc.footer2,false);
opts.view.renderFooter.call(opts.view,_519,dc.footer1,true);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_519);
}
_51a.ss.clean();
opts.onLoadSuccess.call(_519,data);
var _51c=$(_519).datagrid("getPager");
if(_51c.length){
if(_51c.pagination("options").total!=data.total){
_51c.pagination("refresh",{total:data.total});
}
}
_4a9(_519);
dc.body2.triggerHandler("scroll");
_51d();
$(_519).datagrid("autoSizeColumn");
function _51d(){
if(opts.idField){
for(var i=0;i<data.rows.length;i++){
var row=data.rows[i];
if(_51e(_51a.selectedRows,row)){
opts.finder.getTr(_519,i).addClass("datagrid-row-selected");
}
if(_51e(_51a.checkedRows,row)){
opts.finder.getTr(_519,i).find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
}
}
function _51e(a,r){
...
function _51f(_520,row){
var _521=$.data(_520,"datagrid");
...
var data=_524.data;
if(opts.idField){
return _524.selectedRows;
}else{
var rows=[];
opts.finder.getTr(_523,"","selected",2).each(function(){
var _525=parseInt($(this).attr("datagrid-row-index"));
rows.push(data.rows[_525]);
});
return rows;
}
};
function _526(_527){
var _528=$.data(_527,"datagrid");
var opts=_528.options;
if(opts.idField){
return _528.checkedRows;
}else{
var rows=[];
_528.dc.view.find("div.datagrid-cell-check input:checked").each(function(){
var _529=$(this).closest("tr.datagrid-row").attr("datagrid-row-index");
rows.push(opts.finder.getRow(_527,_529));
});
return rows;
}
};
function _52a(_52b,_52c){
var _52d=$.data(_52b,"datagrid");
var dc=_52d.dc;
var opts=_52d.options;
var tr=opts.finder.getTr(_52b,_52c);
if(tr.length){
...
opts.finder.getTr(_532,null,"highlight").removeClass("datagrid-row-over");
opts.finder.getTr(_532,_533).addClass("datagrid-row-over");
$(_532).datagrid("scrollTo",_533);
};
function _534(_535,_536){
var opts=$.data(_535,"datagrid").options;
if(opts.idField){
var _537=_51f(_535,_536);
if(_537>=0){
_538(_535,_537);
}
}
};
function _538(_539,_53a,_53b){
var _53c=$.data(_539,"datagrid");
var dc=_53c.dc;
var opts=_53c.options;
var _53d=_53c.selectedRows;
if(opts.singleSelect){
_53e(_539);
_53d.splice(0,_53d.length);
}
if(!_53b&&opts.checkOnSelect){
_53f(_539,_53a,true);
}
var row=opts.finder.getRow(_539,_53a);
if(opts.idField){
_48a(_53d,opts.idField,row);
}
opts.onSelect.call(_539,_53a,row);
opts.finder.getTr(_539,_53a).addClass("datagrid-row-selected");
$(_539).datagrid("scrollTo",_53a);
};
function _540(_541,_542,_543){
var _544=$.data(_541,"datagrid");
var dc=_544.dc;
var opts=_544.options;
var _545=$.data(_541,"datagrid").selectedRows;
if(!_543&&opts.checkOnSelect){
_546(_541,_542,true);
}
opts.finder.getTr(_541,_542).removeClass("datagrid-row-selected");
var row=opts.finder.getRow(_541,_542);
if(opts.idField){
_488(_545,opts.idField,row[opts.idField]);
}
opts.onUnselect.call(_541,_542,row);
};
function _547(_548,_549){
var _54a=$.data(_548,"datagrid");
var opts=_54a.options;
var rows=_54a.data.rows;
var _54b=$.data(_548,"datagrid").selectedRows;
if(!_549&&opts.checkOnSelect){
_54c(_548,true);
}
opts.finder.getTr(_548,"","allbody").addClass("datagrid-row-selected");
if(opts.idField){
for(var _54d=0;_54d<rows.length;_54d++){
_48a(_54b,opts.idField,rows[_54d]);
}
}
opts.onSelectAll.call(_548,rows);
};
function _53e(_54e,_54f){
var _550=$.data(_54e,"datagrid");
var opts=_550.options;
var rows=_550.data.rows;
var _551=$.data(_54e,"datagrid").selectedRows;
if(!_54f&&opts.checkOnSelect){
_552(_54e,true);
}
opts.finder.getTr(_54e,"","selected").removeClass("datagrid-row-selected");
if(opts.idField){
for(var _553=0;_553<rows.length;_553++){
_488(_551,opts.idField,rows[_553][opts.idField]);
}
}
opts.onUnselectAll.call(_54e,rows);
};
function _53f(_554,_555,_556){
var _557=$.data(_554,"datagrid");
var opts=_557.options;
if(!_556&&opts.selectOnCheck){
_538(_554,_555,true);
}
var ck=opts.finder.getTr(_554,_555).find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",true);
ck=opts.finder.getTr(_554,"","allbody").find("div.datagrid-cell-check input[type=checkbox]:not(:checked)");
if(!ck.length){
var dc=_557.dc;
var _558=dc.header1.add(dc.header2);
_558.find("input[type=checkbox]")._propAttr("checked",true);
}
var row=opts.finder.getRow(_554,_555);
if(opts.idField){
_48a(_557.checkedRows,opts.idField,row);
}
opts.onCheck.call(_554,_555,row);
};
function _546(_559,_55a,_55b){
var _55c=$.data(_559,"datagrid");
var opts=_55c.options;
if(!_55b&&opts.selectOnCheck){
_540(_559,_55a,true);
}
var ck=opts.finder.getTr(_559,_55a).find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",false);
var dc=_55c.dc;
var _55d=dc.header1.add(dc.header2);
_55d.find("input[type=checkbox]")._propAttr("checked",false);
var row=opts.finder.getRow(_559,_55a);
if(opts.idField){
_488(_55c.checkedRows,opts.idField,row[opts.idField]);
}
opts.onUncheck.call(_559,_55a,row);
};
function _54c(_55e,_55f){
var _560=$.data(_55e,"datagrid");
var opts=_560.options;
var rows=_560.data.rows;
if(!_55f&&opts.selectOnCheck){
_547(_55e,true);
}
var dc=_560.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_55e,"","allbody").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",true);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_48a(_560.checkedRows,opts.idField,rows[i]);
}
}
opts.onCheckAll.call(_55e,rows);
};
function _552(_561,_562){
var _563=$.data(_561,"datagrid");
var opts=_563.options;
var rows=_563.data.rows;
if(!_562&&opts.selectOnCheck){
_53e(_561,true);
}
var dc=_563.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_561,"","allbody").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",false);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_488(_563.checkedRows,opts.idField,rows[i][opts.idField]);
}
}
opts.onUncheckAll.call(_561,rows);
};
function _564(_565,_566){
var opts=$.data(_565,"datagrid").options;
var tr=opts.finder.getTr(_565,_566);
var row=opts.finder.getRow(_565,_566);
if(tr.hasClass("datagrid-row-editing")){
return;
}
if(opts.onBeforeEdit.call(_565,_566,row)==false){
return;
}
...
var _568=$(this).parent().attr("field");
var ed=$.data(this,"datagrid.editor");
ed.actions.setValue(ed.target,row[_568]);
});
_569(_565,_566);
};
function _56a(_56b,_56c,_56d){
var opts=$.data(_56b,"datagrid").options;
var _56e=$.data(_56b,"datagrid").updatedRows;
var _56f=$.data(_56b,"datagrid").insertedRows;
var tr=opts.finder.getTr(_56b,_56c);
...
var _571={};
tr.find("div.datagrid-editable").each(function(){
var _572=$(this).parent().attr("field");
var ed=$.data(this,"datagrid.editor");
var _573=ed.actions.getValue(ed.target);
if(row[_572]!=_573){
row[_572]=_573;
_570=true;
_571[_572]=_573;
...
_574(_56b,_56c);
$(_56b).datagrid("refreshRow",_56c);
if(!_56d){
opts.onAfterEdit.call(_56b,_56c,row,_571);
}else{
opts.onCancelEdit.call(_56b,_56c,row);
}
};
...
var _57c=_575(_57a,_57b.index);
for(var i=0;i<_57c.length;i++){
if(_57c[i].field==_57b.field){
return _57c[i];
}
}
return null;
};
function _567(_57d,_57e){
var opts=$.data(_57d,"datagrid").options;
var tr=opts.finder.getTr(_57d,_57e);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _57f=$(this).attr("field");
var col=_4d7(_57d,_57f);
if(col&&col.editor){
var _580,_581;
if(typeof col.editor=="string"){
_580=col.editor;
}else{
_580=col.editor.type;
_581=col.editor.options;
}
var _582=opts.editors[_580];
if(_582){
var _583=cell.html();
var _584=cell._outerWidth();
cell.addClass("datagrid-editable");
cell._outerWidth(_584);
cell.html("<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td></td></tr></table>");
cell.children("table").bind("click dblclick contextmenu",function(e){
e.stopPropagation();
});
$.data(cell[0],"datagrid.editor",{actions:_582,target:_582.init(cell.find("td"),_581),field:_57f,type:_580,oldHtml:_583});
}
}
});
_4a9(_57d,_57e,true);
};
function _574(_585,_586){
...
function _569(_587,_588){
var tr=$.data(_587,"datagrid").options.finder.getTr(_587,_588);
if(!tr.hasClass("datagrid-row-editing")){
return true;
}
...
var _589=tr.find(".validatebox-invalid");
return _589.length==0;
};
function _58a(_58b,_58c){
var _58d=$.data(_58b,"datagrid").insertedRows;
var _58e=$.data(_58b,"datagrid").deletedRows;
var _58f=$.data(_58b,"datagrid").updatedRows;
if(!_58c){
var rows=[];
rows=rows.concat(_58d);
rows=rows.concat(_58e);
rows=rows.concat(_58f);
return rows;
}else{
if(_58c=="inserted"){
return _58d;
...
var data=_593.data;
var _594=_593.insertedRows;
var _595=_593.deletedRows;
$(_591).datagrid("cancelEdit",_592);
var row=data.rows[_592];
if(_487(_594,row)>=0){
_488(_594,row);
}else{
_595.push(row);
}
_488(_593.selectedRows,opts.idField,data.rows[_592][opts.idField]);
_488(_593.checkedRows,opts.idField,data.rows[_592][opts.idField]);
opts.view.deleteRow.call(opts.view,_591,_592);
if(opts.height=="auto"){
_4a9(_591);
}
$(_591).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _596(_597,_598){
var data=$.data(_597,"datagrid").data;
var view=$.data(_597,"datagrid").options.view;
var _599=$.data(_597,"datagrid").insertedRows;
view.insertRow.call(view,_597,_598.index,_598.row);
_599.push(_598.row);
$(_597).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _59a(_59b,row){
var data=$.data(_59b,"datagrid").data;
var view=$.data(_59b,"datagrid").options.view;
var _59c=$.data(_59b,"datagrid").insertedRows;
view.insertRow.call(view,_59b,null,row);
_59c.push(row);
$(_59b).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _59d(_59e){
...
var _5a0=[];
for(var i=0;i<rows.length;i++){
_5a0.push($.extend({},rows[i]));
}
_59f.originalRows=_5a0;
_59f.updatedRows=[];
_59f.insertedRows=[];
_59f.deletedRows=[];
};
function _5a1(_5a2){
var data=$.data(_5a2,"datagrid").data;
var ok=true;
...
var _5a6=_5a5.originalRows;
var _5a7=_5a5.insertedRows;
var _5a8=_5a5.deletedRows;
var _5a9=_5a5.selectedRows;
var _5aa=_5a5.checkedRows;
var data=_5a5.data;
function _5ab(a){
var ids=[];
for(var i=0;i<a.length;i++){
...
function _5ac(ids,_5ad){
for(var i=0;i<ids.length;i++){
var _5ae=_51f(_5a4,ids[i]);
if(_5ae>=0){
(_5ad=="s"?_538:_53f)(_5a4,_5ae,true);
}
}
};
for(var i=0;i<data.rows.length;i++){
...
_5aa.splice(0,_5aa.length);
data.total+=_5a8.length-_5a7.length;
data.rows=_5a6;
_518(_5a4,data);
_5ac(_5af,"s");
_5ac(_5b0,"c");
...
var opts=$.data(_5b2,"datagrid").options;
if(_5b3){
opts.queryParams=_5b3;
}
var _5b4=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_5b4,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_5b4,{sort:opts.sortName,order:opts.sortOrder});
}
if(opts.onBeforeLoad.call(_5b2,_5b4)==false){
return;
}
$(_5b2).datagrid("loading");
setTimeout(function(){
_5b5();
},0);
function _5b5(){
var _5b6=opts.loader.call(_5b2,_5b4,function(data){
setTimeout(function(){
$(_5b2).datagrid("loaded");
},0);
_518(_5b2,data);
setTimeout(function(){
_59d(_5b2);
...
opts.onLoadError.apply(_5b2,arguments);
});
if(_5b6==false){
$(_5b2).datagrid("loaded");
}
...
_5b9.rowspan=_5b9.rowspan||1;
_5b9.colspan=_5b9.colspan||1;
if(_5b9.rowspan==1&&_5b9.colspan==1){
return;
}
var tr=opts.finder.getTr(_5b8,(_5b9.index!=undefined?_5b9.index:_5b9.id));
if(!tr.length){
return;
}
var row=opts.finder.getRow(_5b8,tr);
var _5ba=row[_5b9.field];
var td=tr.find("td[field=\""+_5b9.field+"\"]");
td.attr("rowspan",_5b9.rowspan).attr("colspan",_5b9.colspan);
td.addClass("datagrid-td-merged");
for(var i=1;i<_5b9.colspan;i++){
td=td.next();
td.hide();
row[td.attr("field")]=_5ba;
}
for(var i=1;i<_5b9.rowspan;i++){
tr=tr.next();
if(!tr.length){
break;
}
var row=opts.finder.getRow(_5b8,tr);
var td=tr.find("td[field=\""+_5b9.field+"\"]").hide();
row[td.attr("field")]=_5ba;
for(var j=1;j<_5b9.colspan;j++){
td=td.next();
td.hide();
row[td.attr("field")]=_5ba;
}
...
$.fn.datagrid=function(_5bb,_5bc){
if(typeof _5bb=="string"){
return $.fn.datagrid.methods[_5bb](this,_5bc);
}
_5bb=_5bb||{};
return this.each(function(){
var _5bd=$.data(this,"datagrid");
var opts;
if(_5bd){
opts=$.extend(_5bd.options,_5bb);
_5bd.options=opts;
}else{
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryParams:{}}),$.fn.datagrid.parseOptions(this),_5bb);
$(this).css("width","").css("height","");
var _5be=_4ba(this,opts.rownumbers);
if(!opts.columns){
opts.columns=_5be.columns;
}
if(!opts.frozenColumns){
opts.frozenColumns=_5be.frozenColumns;
}
opts.columns=$.extend(true,[],opts.columns);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.view=$.extend({},opts.view);
$.data(this,"datagrid",{options:opts,panel:_5be.panel,dc:_5be.dc,ss:_5be.ss,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_4c6(this);
if(opts.data){
_518(this,opts.data);
...
var _5bf={text:{init:function(_5c0,_5c1){
var _5c2=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_5c0);
return _5c2;
},getValue:function(_5c3){
return $(_5c3).val();
},setValue:function(_5c4,_5c5){
$(_5c4).val(_5c5);
},resize:function(_5c6,_5c7){
$(_5c6)._outerWidth(_5c7);
}},textarea:{init:function(_5c8,_5c9){
var _5ca=$("<textarea class=\"datagrid-editable-input\"></textarea>").appendTo(_5c8);
return _5ca;
...
}},checkbox:{init:function(_5d0,_5d1){
var _5d2=$("<input type=\"checkbox\">").appendTo(_5d0);
_5d2.val(_5d1.on);
_5d2.attr("offval",_5d1.off);
return _5d2;
},getValue:function(_5d3){
if($(_5d3).is(":checked")){
return $(_5d3).val();
}else{
return $(_5d3).attr("offval");
}
...
$(_5d4)._propAttr("checked",_5d6);
}},numberbox:{init:function(_5d7,_5d8){
var _5d9=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_5d7);
_5d9.numberbox(_5d8);
return _5d9;
},destroy:function(_5da){
$(_5da).numberbox("destroy");
},getValue:function(_5db){
$(_5db).blur();
return $(_5db).numberbox("getValue");
},setValue:function(_5dc,_5dd){
$(_5dc).numberbox("setValue",_5dd);
},resize:function(_5de,_5df){
$(_5de)._outerWidth(_5df);
}},validatebox:{init:function(_5e0,_5e1){
var _5e2=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_5e0);
_5e2.validatebox(_5e1);
return _5e2;
},destroy:function(_5e3){
$(_5e3).validatebox("destroy");
},getValue:function(_5e4){
return $(_5e4).val();
},setValue:function(_5e5,_5e6){
$(_5e5).val(_5e6);
},resize:function(_5e7,_5e8){
$(_5e7)._outerWidth(_5e8);
}},datebox:{init:function(_5e9,_5ea){
var _5eb=$("<input type=\"text\">").appendTo(_5e9);
_5eb.datebox(_5ea);
return _5eb;
},destroy:function(_5ec){
$(_5ec).datebox("destroy");
},getValue:function(_5ed){
return $(_5ed).datebox("getValue");
},setValue:function(_5ee,_5ef){
$(_5ee).datebox("setValue",_5ef);
},resize:function(_5f0,_5f1){
$(_5f0).datebox("resize",_5f1);
}},combobox:{init:function(_5f2,_5f3){
var _5f4=$("<input type=\"text\">").appendTo(_5f2);
_5f4.combobox(_5f3||{});
return _5f4;
},destroy:function(_5f5){
$(_5f5).combobox("destroy");
},getValue:function(_5f6){
return $(_5f6).combobox("getValue");
},setValue:function(_5f7,_5f8){
$(_5f7).combobox("setValue",_5f8);
},resize:function(_5f9,_5fa){
$(_5f9).combobox("resize",_5fa);
}},combotree:{init:function(_5fb,_5fc){
var _5fd=$("<input type=\"text\">").appendTo(_5fb);
_5fd.combotree(_5fc);
return _5fd;
},destroy:function(_5fe){
$(_5fe).combotree("destroy");
},getValue:function(_5ff){
return $(_5ff).combotree("getValue");
},setValue:function(_600,_601){
$(_600).combotree("setValue",_601);
},resize:function(_602,_603){
$(_602).combotree("resize",_603);
}}};
$.fn.datagrid.methods={options:function(jq){
var _604=$.data(jq[0],"datagrid").options;
var _605=$.data(jq[0],"datagrid").panel.panel("options");
var opts=$.extend(_604,{width:_605.width,height:_605.height,closed:_605.closed,collapsed:_605.collapsed,minimized:_605.minimized,maximized:_605.maximized});
return opts;
},getPanel:function(jq){
return $.data(jq[0],"datagrid").panel;
},getPager:function(jq){
return $.data(jq[0],"datagrid").panel.children("div.datagrid-pager");
},getColumnFields:function(jq,_606){
return _4d6(jq[0],_606);
},getColumnOption:function(jq,_607){
return _4d7(jq[0],_607);
},resize:function(jq,_608){
return jq.each(function(){
_498(this,_608);
});
},load:function(jq,_609){
return jq.each(function(){
var opts=$(this).datagrid("options");
opts.pageNumber=1;
var _60a=$(this).datagrid("getPager");
_60a.pagination({pageNumber:1});
_5b1(this,_609);
});
},reload:function(jq,_60b){
return jq.each(function(){
_5b1(this,_60b);
});
},reloadFooter:function(jq,_60c){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
var dc=$.data(this,"datagrid").dc;
if(_60c){
$.data(this,"datagrid").footer=_60c;
}
if(opts.showFooter){
...
$("<div class=\"datagrid-mask\" style=\"display:block\"></div>").appendTo(_60d);
var msg=$("<div class=\"datagrid-mask-msg\" style=\"display:block;left:50%\"></div>").html(opts.loadMsg).appendTo(_60d);
...
var _60e=$(this).datagrid("getPanel");
_60e.children("div.datagrid-mask-msg").remove();
_60e.children("div.datagrid-mask").remove();
});
},fitColumns:function(jq){
return jq.each(function(){
_4ec(this);
});
},fixColumnSize:function(jq,_60f){
return jq.each(function(){
_4c2(this,_60f);
});
},fixRowHeight:function(jq,_610){
return jq.each(function(){
_4a9(this,_610);
});
},freezeRow:function(jq,_611){
return jq.each(function(){
_4b3(this,_611);
});
},autoSizeColumn:function(jq,_612){
return jq.each(function(){
_4f8(this,_612);
});
},loadData:function(jq,data){
...
return jq.each(function(){
var _613=$.data(this,"datagrid").selectedRows;
_613.splice(0,_613.length);
_53e(this);
});
},clearChecked:function(jq){
return jq.each(function(){
var _614=$.data(this,"datagrid").checkedRows;
_614.splice(0,_614.length);
_552(this);
});
},scrollTo:function(jq,_615){
return jq.each(function(){
_52a(this,_615);
});
},highlightRow:function(jq,_616){
return jq.each(function(){
_531(this,_616);
});
...
return _575(jq[0],_61e);
},getEditor:function(jq,_61f){
return _579(jq[0],_61f);
...
},editors:_5bf,finder:{getTr:function(_66b,_66c,type,_66d){
type=type||"body";
_66d=_66d||0;
...
_790.find(".combo-arrow").show();
}else{
_790.find(".combo-arrow").hide();
}
};
function init(_791){
$(_791).addClass("combo-f").hide();
var span=$("<span class=\"combo\"></span>").insertAfter(_791);
var _792=$("<input type=\"text\" class=\"combo-text\">").appendTo(span);
$("<span><span class=\"combo-arrow\"></span></span>").appendTo(span);
$("<input type=\"hidden\" class=\"combo-value\">").appendTo(span);
var _793=$("<div class=\"combo-panel\"></div>").appendTo("body");
_793.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
},onClose:function(){
var _794=$.data(_791,"combo");
if(_794){
_794.options.onHidePanel.call(_791);
}
}});
var name=$(_791).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_791).removeAttr("name").attr("comboName",name);
}
_792.attr("autocomplete","off");
return {combo:span,panel:_793};
};
function _795(_796){
var _797=$.data(_796,"combo");
var _798=_797.combo.find("input.combo-text");
_798.validatebox("destroy");
_797.panel.panel("destroy");
_797.combo.remove();
$(_796).remove();
};
function _799(_79a){
var _79b=$.data(_79a,"combo");
var opts=_79b.options;
var _79c=_79b.panel;
var _79d=_79b.combo;
var _79e=_79d.find(".combo-text");
var _79f=_79d.find(".combo-arrow");
...
_79f.unbind(".combo");
if(!opts.disabled){
_79e.bind("mousedown.combo",function(e){
$("div.combo-panel").not(_79c).panel("close");
e.stopPropagation();
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_79a);
break;
case 40:
opts.keyHandler.down.call(_79a);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_79a);
return false;
case 9:
case 27:
_7a6(_79a);
...
if(opts.editable){
if(_79b.timer){
clearTimeout(_79b.timer);
}
_79b.timer=setTimeout(function(){
var q=_79e.val();
if(_79b.previousValue!=q){
_79b.previousValue=q;
$(_79a).combo("showPanel");
opts.keyHandler.query.call(_79a,_79e.val());
_7a9(_79a,true);
}
},opts.delay);
}
...
_79f.bind("click.combo",function(){
if(_79c.is(":visible")){
_7a6(_79a);
}else{
...
var _7a3=$.data(_7a1,"combo").panel;
if($.fn.window){
_7a3.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_7a3.panel("move",{left:_7a2.offset().left,top:_7a4()});
if(_7a3.panel("options").closed){
_7a3.panel("open");
opts.onShowPanel.call(_7a1);
}
(function(){
if(_7a3.is(":visible")){
_7a3.panel("move",{left:_7a5(),top:_7a4()});
setTimeout(arguments.callee,200);
}
})();
function _7a5(){
var left=_7a2.offset().left;
if(left+_7a3._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_7a3._outerWidth();
}
if(left<0){
left=0;
}
...
function _7a4(){
var top=_7a2.offset().top+_7a2._outerHeight();
if(top+_7a3._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_7a2.offset().top-_7a3._outerHeight();
}
if(top<$(document).scrollTop()){
top=_7a2.offset().top+_7a2._outerHeight();
}
return top;
};
};
function _7a6(_7a7){
var _7a8=$.data(_7a7,"combo").panel;
_7a8.panel("close");
};
function _7a9(_7aa,doit){
var opts=$.data(_7aa,"combo").options;
var _7ab=$.data(_7aa,"combo").combo.find("input.combo-text");
_7ab.validatebox($.extend({},opts,{deltaX:(opts.hasDownArrow?opts.deltaX:(opts.deltaX>0?1:-1))}));
if(doit){
_7ab.validatebox("validate");
}
};
function _7ac(_7ad,_7ae){
var opts=$.data(_7ad,"combo").options;
var _7af=$.data(_7ad,"combo").combo;
if(_7ae){
opts.disabled=true;
$(_7ad).attr("disabled",true);
_7af.find(".combo-value").attr("disabled",true);
_7af.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_7ad).removeAttr("disabled");
_7af.find(".combo-value").removeAttr("disabled");
_7af.find(".combo-text").removeAttr("disabled");
}
};
function _7b0(_7b1){
var opts=$.data(_7b1,"combo").options;
var _7b2=$.data(_7b1,"combo").combo;
if(opts.multiple){
_7b2.find("input.combo-value").remove();
}else{
_7b2.find("input.combo-value").val("");
}
_7b2.find("input.combo-text").val("");
};
function _7b3(_7b4){
var _7b5=$.data(_7b4,"combo").combo;
return _7b5.find("input.combo-text").val();
};
function _7b6(_7b7,text){
var _7b8=$.data(_7b7,"combo").combo;
_7b8.find("input.combo-text").val(text);
_7a9(_7b7,true);
$.data(_7b7,"combo").previousValue=text;
};
function _7b9(_7ba){
var _7bb=[];
var _7bc=$.data(_7ba,"combo").combo;
_7bc.find("input.combo-value").each(function(){
_7bb.push($(this).val());
});
return _7bb;
};
...
var _7c0=_7b9(_7be);
var _7c1=$.data(_7be,"combo").combo;
_7c1.find("input.combo-value").remove();
var name=$(_7be).attr("comboName");
for(var i=0;i<_7bf.length;i++){
var _7c2=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_7c1);
if(name){
_7c2.attr("name",name);
}
_7c2.val(_7bf[i]);
...
if(aa.length!=_7bf.length||_7bf.length!=_7c0.length){
if(opts.multiple){
opts.onChange.call(_7be,_7bf,_7c0);
}else{
opts.onChange.call(_7be,_7bf[0],_7c0[0]);
}
}
};
function _7c3(_7c4){
...
function _7c9(_7ca){
var opts=$.data(_7ca,"combo").options;
var fn=opts.onChange;
opts.onChange=function(){
};
if(opts.multiple){
...
_7bd(_7ca,opts.value);
}else{
_7c6(_7ca,opts.value);
}
}else{
_7bd(_7ca,[]);
}
opts.originalValue=_7b9(_7ca);
}else{
_7c6(_7ca,opts.value);
...
$.fn.combo=function(_7cb,_7cc){
if(typeof _7cb=="string"){
return $.fn.combo.methods[_7cb](this,_7cc);
}
_7cb=_7cb||{};
return this.each(function(){
var _7cd=$.data(this,"combo");
if(_7cd){
$.extend(_7cd.options,_7cb);
}else{
var r=init(this);
_7cd=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_7cb),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
$("input.combo-text",_7cd.combo).attr("readonly",!_7cd.options.editable);
_78e(this);
_7ac(this,_7cd.options.disabled);
_786(this);
_799(this);
_7a9(this);
_7c9(this);
...
var _7cf=$.data(jq[0],"combo").combo.find("input.combo-text");
return _7cf.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_7b0(this);
});
...
$.fn.combo.parseOptions=function(_7d2){
var t=$(_7d2);
return $.extend({},$.fn.validatebox.parseOptions(_7d2),$.parser.parseOptions(_7d2,["width","height","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),value:(t.val()||undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:22,panelWidth:null,panelHeight:200,multiple:false,selectOnNavigation:true,separator:",",editable:true,disabled:false,hasDownArrow:true,value:"",delay:200,deltaX:19,keyHandler:{up:function(){
},down:function(){
},enter:function(){
},query:function(q){
}},onShowPanel:function(){
},onHidePanel:function(){
},onChange:function(_7d3,_7d4){
}});
})(jQuery);
(function($){
function _7d5(data,key,_7d6){
for(var i=0;i<data.length;i++){
var item=data[i];
if(item[key]==_7d6){
return item;
...
var _7da=$(_7d8).combo("panel");
var item=_7da.find("div.combobox-item[value=\""+_7d9+"\"]");
if(item.length){
if(item.position().top<=0){
var h=_7da.scrollTop()+item.position().top;
_7da.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_7da.height()){
var h=_7da.scrollTop()+item.position().top+item.outerHeight()-_7da.height();
_7da.scrollTop(h);
}
}
}
};
function nav(_7db,dir){
var opts=$(_7db).combobox("options");
var _7dc=$(_7db).combobox("panel");
var item=_7dc.children("div.combobox-item-hover");
if(!item.length){
item=_7dc.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
if(!item.length){
item=_7dc.children("div.combobox-item:visible:"+(dir=="next"?"first":"last"));
}else{
if(dir=="next"){
item=item.nextAll(":visible:first");
if(!item.length){
item=_7dc.children("div.combobox-item:visible:first");
}
}else{
item=item.prevAll(":visible:first");
if(!item.length){
item=_7dc.children("div.combobox-item:visible:last");
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
_7d7(_7db,item.attr("value"));
if(opts.selectOnNavigation){
_7dd(_7db,item.attr("value"));
}
}
};
function _7dd(_7de,_7df){
var opts=$.data(_7de,"combobox").options;
var data=$.data(_7de,"combobox").data;
if(opts.multiple){
var _7e0=$(_7de).combo("getValues");
...
var item=_7d5(data,opts.valueField,_7df);
if(item){
opts.onSelect.call(_7de,item);
}
};
function _7e2(_7e3,_7e4){
var _7e5=$.data(_7e3,"combobox");
var opts=_7e5.options;
var _7e6=$(_7e3).combo("getValues");
var _7e7=_7e6.indexOf(_7e4+"");
if(_7e7>=0){
_7e6.splice(_7e7,1);
_7e1(_7e3,_7e6);
}
var item=_7d5(_7e5.data,opts.valueField,_7e4);
if(item){
opts.onUnselect.call(_7e3,item);
}
};
function _7e1(_7e8,_7e9,_7ea){
var opts=$.data(_7e8,"combobox").options;
var data=$.data(_7e8,"combobox").data;
var _7eb=$(_7e8).combo("panel");
_7eb.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
for(var i=0;i<_7e9.length;i++){
var v=_7e9[i];
var s=v;
var item=_7d5(data,opts.valueField,v);
if(item){
s=item[opts.textField];
}
vv.push(v);
ss.push(s);
_7eb.find("div.combobox-item[value=\""+v+"\"]").addClass("combobox-item-selected");
}
$(_7e8).combo("setValues",vv);
if(!_7ea){
$(_7e8).combo("setText",ss.join(opts.separator));
}
};
function _7ec(_7ed,data,_7ee){
var opts=$.data(_7ed,"combobox").options;
var _7ef=$(_7ed).combo("panel");
data=opts.loadFilter.call(_7ed,data);
$.data(_7ed,"combobox").data=data;
var _7f0=$(_7ed).combobox("getValues");
_7ef.empty();
for(var i=0;i<data.length;i++){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=$("<div class=\"combobox-item\"></div>").appendTo(_7ef);
item.attr("value",v);
if(opts.formatter){
item.html(opts.formatter.call(_7ed,data[i]));
}else{
item.html(s);
}
if(data[i]["selected"]){
...
if(_7f0.length){
_7e1(_7ed,[_7f0[_7f0.length-1]],_7ee);
}else{
_7e1(_7ed,[],_7ee);
}
}
...
function _7f1(_7f2,url,_7f3,_7f4){
var opts=$.data(_7f2,"combobox").options;
if(url){
opts.url=url;
}
_7f3=_7f3||{};
if(opts.onBeforeLoad.call(_7f2,_7f3)==false){
return;
}
opts.loader.call(_7f2,_7f3,function(data){
_7ec(_7f2,data,_7f4);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _7f5(_7f6,q){
var opts=$.data(_7f6,"combobox").options;
if(opts.multiple&&!q){
_7e1(_7f6,[],true);
}else{
_7e1(_7f6,[q],true);
...
if(opts.mode=="remote"){
_7f1(_7f6,null,{q:q},true);
}else{
var _7f7=$(_7f6).combo("panel");
_7f7.find("div.combobox-item").hide();
var data=$.data(_7f6,"combobox").data;
for(var i=0;i<data.length;i++){
if(opts.filter.call(_7f6,q,data[i])){
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_7f7.find("div.combobox-item[value=\""+v+"\"]");
item.show();
if(s==q){
_7e1(_7f6,[v],true);
...
function _7f8(_7f9){
var t=$(_7f9);
var _7fa=t.combobox("panel");
var opts=t.combobox("options");
var data=t.combobox("getData");
var item=_7fa.children("div.combobox-item-hover");
if(!item.length){
item=_7fa.children("div.combobox-item-selected");
}
if(!item.length){
return;
}
...
var vv=[];
var _7fb=t.combobox("getValues");
for(var i=0;i<_7fb.length;i++){
if(_7d5(data,opts.valueField,_7fb[i])){
vv.push(_7fb[i]);
}
}
...
function _7fc(_7fd){
var opts=$.data(_7fd,"combobox").options;
$(_7fd).addClass("combobox-f");
$(_7fd).combo($.extend({},opts,{onShowPanel:function(){
$(_7fd).combo("panel").find("div.combobox-item").show();
_7d7(_7fd,$(_7fd).combobox("getValue"));
opts.onShowPanel.call(_7fd);
}}));
$(_7fd).combo("panel").unbind().bind("mouseover",function(e){
...
$.fn.combobox=function(_7ff,_800){
if(typeof _7ff=="string"){
var _801=$.fn.combobox.methods[_7ff];
if(_801){
return _801(this,_800);
}else{
return this.combo(_7ff,_800);
}
}
_7ff=_7ff||{};
return this.each(function(){
var _802=$.data(this,"combobox");
if(_802){
$.extend(_802.options,_7ff);
_7fc(this);
}else{
_802=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_7ff)});
_7fc(this);
_7ec(this,$.fn.combobox.parseData(this));
}
if(_802.options.data){
_7ec(this,_802.options.data);
}
_7f1(this);
});
};
...
},setValues:function(jq,_803){
return jq.each(function(){
_7e1(this,_803);
});
},setValue:function(jq,_804){
return jq.each(function(){
_7e1(this,[_804]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _805=$(this).combo("panel");
_805.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_806){
return jq.each(function(){
_7dd(this,_806);
});
},unselect:function(jq,_807){
return jq.each(function(){
_7e2(this,_807);
});
}};
$.fn.combobox.parseOptions=function(_808){
var t=$(_808);
return $.extend({},$.fn.combo.parseOptions(_808),$.parser.parseOptions(_808,["valueField","textField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_809){
var data=[];
var opts=$(_809).combobox("options");
$(_809).children("option").each(function(){
var item={};
...
},loader:function(_80a,_80b,_80c){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_80a,dataType:"json",success:function(data){
_80b(data);
},error:function(){
_80c.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},onBeforeLoad:function(_80d){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_80e){
},onUnselect:function(_80f){
}});
})(jQuery);
(function($){
function _810(_811){
var opts=$.data(_811,"combotree").options;
var tree=$.data(_811,"combotree").tree;
$(_811).addClass("combotree-f");
$(_811).combo(opts);
var _812=$(_811).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_812);
$.data(_811,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _813=$(_811).combotree("getValues");
if(opts.multiple){
var _814=tree.tree("getChecked");
...
$(_811).combotree("setValues",_813);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_816(_811);
$(_811).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_815){
_816(_811);
opts.onCheck.call(this,node,_815);
}}));
};
function _816(_817){
var opts=$.data(_817,"combotree").options;
var tree=$.data(_817,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _818=tree.tree("getChecked");
...
$(_817).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _819(_81a,_81b){
var opts=$.data(_81a,"combotree").options;
var tree=$.data(_81a,"combotree").tree;
...
$(_81a).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_81c,_81d){
if(typeof _81c=="string"){
var _81e=$.fn.combotree.methods[_81c];
if(_81e){
return _81e(this,_81d);
}else{
return this.combo(_81c,_81d);
}
}
_81c=_81c||{};
return this.each(function(){
var _81f=$.data(this,"combotree");
if(_81f){
$.extend(_81f.options,_81c);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_81c)});
}
_810(this);
});
};
...
$.fn.combotree.parseOptions=function(_822){
return $.extend({},$.fn.combo.parseOptions(_822),$.fn.tree.parseOptions(_822));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _823(_824){
var _825=$.data(_824,"combogrid");
var opts=_825.options;
var grid=_825.grid;
$(_824).addClass("combogrid-f").combo(opts);
var _826=$(_824).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_826);
_825.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _827=$(_824).combo("getValues");
var _828=opts.onSelect;
opts.onSelect=function(){
};
_832(_824,_827,_825.remainText);
opts.onSelect=_828;
opts.onLoadSuccess.apply(_824,arguments);
},onClickRow:_829,onSelect:function(_82a,row){
_82b();
opts.onSelect.call(this,_82a,row);
},onUnselect:function(_82c,row){
_82b();
opts.onUnselect.call(this,_82c,row);
},onSelectAll:function(rows){
_82b();
...
function _829(_82d,row){
_825.remainText=false;
_82b();
if(!opts.multiple){
$(_824).combo("hidePanel");
}
opts.onClickRow.call(this,_82d,row);
};
function _82b(){
...
if(!opts.multiple){
$(_824).combo("setValues",(vv.length?vv:[""]));
}else{
$(_824).combo("setValues",vv);
}
if(!_825.remainText){
...
function nav(_82e,dir){
var _82f=$.data(_82e,"combogrid");
var opts=_82f.options;
var grid=_82f.grid;
var _830=grid.datagrid("getRows").length;
if(!_830){
return;
}
...
var _831;
if(!tr.length){
_831=(dir=="next"?0:_830-1);
}else{
var _831=parseInt(tr.attr("datagrid-row-index"));
_831+=(dir=="next"?1:-1);
if(_831<0){
_831=_830-1;
}
...
grid.datagrid("highlightRow",_831);
if(opts.selectOnNavigation){
_82f.remainText=false;
grid.datagrid("selectRow",_831);
}
};
function _832(_833,_834,_835){
var _836=$.data(_833,"combogrid");
var opts=_836.options;
var grid=_836.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _837=$(_833).combo("getValues");
var _838=$(_833).combo("options");
var _839=_838.onChange;
_838.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_834.length;i++){
var _83a=grid.datagrid("getRowIndex",_834[i]);
if(_83a>=0){
grid.datagrid("selectRow",_83a);
ss.push(rows[_83a][opts.textField]);
}else{
ss.push(_834[i]);
}
}
$(_833).combo("setValues",_837);
_838.onChange=_839;
$(_833).combo("setValues",_834);
if(!_835){
var s=ss.join(opts.separator);
if($(_833).combo("getText")!=s){
$(_833).combo("setText",s);
}
}
};
function _83b(_83c,q){
var _83d=$.data(_83c,"combogrid");
var opts=_83d.options;
var grid=_83d.grid;
_83d.remainText=true;
if(opts.multiple&&!q){
_832(_83c,[],true);
}else{
_832(_83c,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_83c,q,rows[i])){
grid.datagrid("clearSelections");
...
var _841=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_841);
}else{
grid.datagrid("selectRow",_841);
}
}else{
grid.datagrid("selectRow",_841);
$(_83f).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_842,_843){
if(typeof _842=="string"){
var _844=$.fn.combogrid.methods[_842];
if(_844){
return _844(this,_843);
}else{
return $.fn.combo.methods[_842](this,_843);
}
}
_842=_842||{};
return this.each(function(){
var _845=$.data(this,"combogrid");
if(_845){
$.extend(_845.options,_842);
}else{
_845=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_842)});
}
_823(this);
});
};
...
$.fn.combogrid.parseOptions=function(_848){
var t=$(_848);
return $.extend({},$.fn.combo.parseOptions(_848),$.fn.datagrid.parseOptions(_848),$.parser.parseOptions(_848,["idField","textField","mode"]));
};
...
(function($){
function _849(_84a){
var _84b=$.data(_84a,"datebox");
var opts=_84b.options;
$(_84a).addClass("datebox-f");
$(_84a).combo($.extend({},opts,{onShowPanel:function(){
_84b.calendar.calendar("resize");
opts.onShowPanel.call(_84a);
}}));
$(_84a).combo("textbox").parent().addClass("datebox");
if(!_84b.calendar){
_84c();
}
function _84c(){
var _84d=$(_84a).combo("panel");
_84b.calendar=$("<div></div>").appendTo(_84d).wrap("<div class=\"datebox-calendar-inner\"></div>");
_84b.calendar.calendar({fit:true,border:false,onSelect:function(date){
var _84e=opts.formatter(date);
_852(_84a,_84e);
$(_84a).combo("hidePanel");
opts.onSelect.call(_84a,date);
}});
_852(_84a,opts.value);
var _84f=$("<div class=\"datebox-button\"></div>").appendTo(_84d);
$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_84f);
$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_84f);
_84f.find(".datebox-current,.datebox-close").hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
});
_84f.find(".datebox-current").click(function(){
_84b.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_84f.find(".datebox-close").click(function(){
$(_84a).combo("hidePanel");
});
};
};
...
function _853(_854){
var opts=$.data(_854,"datebox").options;
var c=$.data(_854,"datebox").calendar;
var _855=opts.formatter(c.calendar("options").current);
_852(_854,_855);
$(_854).combo("hidePanel");
};
function _852(_856,_857){
var _858=$.data(_856,"datebox");
var opts=_858.options;
$(_856).combo("setValue",_857).combo("setText",_857);
_858.calendar.calendar("moveTo",opts.parser(_857));
};
$.fn.datebox=function(_859,_85a){
if(typeof _859=="string"){
var _85b=$.fn.datebox.methods[_859];
if(_85b){
...
_859=_859||{};
return this.each(function(){
var _85c=$.data(this,"datebox");
if(_85c){
$.extend(_85c.options,_859);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_859)});
}
_849(this);
});
};
...
$.fn.datebox.parseOptions=function(_85e){
var t=$(_85e);
return $.extend({},$.fn.combo.parseOptions(_85e),{});
};
...
(function($){
function _85f(_860){
var _861=$.data(_860,"datetimebox");
var opts=_861.options;
$(_860).datebox($.extend({},opts,{onShowPanel:function(){
var _862=$(_860).datetimebox("getValue");
_865(_860,_862,true);
opts.onShowPanel.call(_860);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_860).removeClass("datebox-f").addClass("datetimebox-f");
$(_860).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_860,date);
}});
var _863=$(_860).datebox("panel");
if(!_861.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_863.children("div.datebox-calendar-inner"));
_861.spinner=p.children("input");
var _864=_863.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_864);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
...
_861.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_865(_860,opts.value);
};
function _866(_867){
var c=$(_867).datetimebox("calendar");
var t=$(_867).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _868(_869,q){
_865(_869,q,true);
};
function _86a(_86b){
var opts=$.data(_86b,"datetimebox").options;
var date=_866(_86b);
_865(_86b,opts.formatter.call(_86b,date));
$(_86b).combo("hidePanel");
};
function _865(_86c,_86d,_86e){
var opts=$.data(_86c,"datetimebox").options;
$(_86c).combo("setValue",_86d);
if(!_86e){
if(_86d){
var date=opts.parser.call(_86c,_86d);
$(_86c).combo("setValue",opts.formatter.call(_86c,date));
$(_86c).combo("setText",opts.formatter.call(_86c,date));
}else{
$(_86c).combo("setText",_86d);
}
}
var date=opts.parser.call(_86c,_86d);
$(_86c).datetimebox("calendar").calendar("moveTo",date);
$(_86c).datetimebox("spinner").timespinner("setValue",_86f(date));
function _86f(date){
function _870(_871){
return (_871<10?"0":"")+_871;
};
var tt=[_870(date.getHours()),_870(date.getMinutes())];
if(opts.showSeconds){
tt.push(_870(date.getSeconds()));
}
return tt.join($(_86c).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_872,_873){
if(typeof _872=="string"){
var _874=$.fn.datetimebox.methods[_872];
if(_874){
return _874(this,_873);
}else{
return this.datebox(_872,_873);
}
}
_872=_872||{};
return this.each(function(){
var _875=$.data(this,"datetimebox");
if(_875){
$.extend(_875.options,_872);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_872)});
}
_85f(this);
});
};
...
$.fn.datetimebox.parseOptions=function(_877){
var t=$(_877);
return $.extend({},$.fn.datebox.parseOptions(_877),$.parser.parseOptions(_877,["timeSeparator",{showSeconds:"boolean"}]));
};
...
function _878(_879){
return (_879<10?"0":"")+_879;
};
var _87a=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_878(h)+_87a+_878(M);
...
var _87b=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_87b);
var hour=parseInt(tt[0],10)||0;
var _87c=parseInt(tt[1],10)||0;
var _87d=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_87c,_87d);
}});
})(jQuery);
(function($){
function init(_87e){
var _87f=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_87e);
var name=$(_87e).hide().attr("name");
if(name){
_87f.find("input.slider-value").attr("name",name);
$(_87e).removeAttr("name").attr("sliderName",name);
}
return _87f;
};
function _880(_881,_882){
var _883=$.data(_881,"slider");
var opts=_883.options;
var _884=_883.slider;
if(_882){
if(_882.width){
opts.width=_882.width;
}
if(_882.height){
opts.height=_882.height;
}
}
if(opts.mode=="h"){
_884.css("height","");
_884.children("div").css("height","");
if(!isNaN(opts.width)){
_884.width(opts.width);
}
}else{
_884.css("width","");
_884.children("div").css("width","");
if(!isNaN(opts.height)){
_884.height(opts.height);
_884.find("div.slider-rule").height(opts.height);
_884.find("div.slider-rulelabel").height(opts.height);
_884.find("div.slider-inner")._outerHeight(opts.height);
}
}
_885(_881);
};
function _886(_887){
var _888=$.data(_887,"slider");
var opts=_888.options;
var _889=_888.slider;
...
_88a(aa);
function _88a(aa){
var rule=_889.find("div.slider-rule");
var _88b=_889.find("div.slider-rulelabel");
rule.empty();
_88b.empty();
for(var i=0;i<aa.length;i++){
var _88c=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_88c);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_88b);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_88c,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_88c,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _88d(_88e){
var _88f=$.data(_88e,"slider");
var opts=_88f.options;
var _890=_88f.slider;
_890.removeClass("slider-h slider-v slider-disabled");
_890.addClass(opts.mode=="h"?"slider-h":"slider-v");
_890.addClass(opts.disabled?"slider-disabled":"");
_890.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _892=_8a3(_88e,left);
_893(_892);
return false;
}
},onStartDrag:function(){
opts.onSlideStart.call(_88e,opts.value);
},onStopDrag:function(e){
var _894=_8a3(_88e,(opts.mode=="h"?e.data.left:e.data.top));
_893(_894);
opts.onSlideEnd.call(_88e,opts.value);
}});
function _893(_895){
var s=Math.abs(_895%opts.step);
if(s<opts.step/2){
_895-=s;
}else{
_895=_895-s+opts.step;
}
_896(_88e,_895);
};
};
function _896(_897,_898){
var _899=$.data(_897,"slider");
var opts=_899.options;
var _89a=_899.slider;
var _89b=opts.value;
if(_898<opts.min){
_898=opts.min;
}
...
opts.value=_898;
$(_897).val(_898);
_89a.find("input.slider-value").val(_898);
var pos=_89c(_897,_898);
var tip=_89a.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_897,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _89d="left:"+pos+"px;";
_89a.find(".slider-handle").attr("style",_89d);
tip.attr("style",_89d+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _89d="top:"+pos+"px;";
_89a.find(".slider-handle").attr("style",_89d);
tip.attr("style",_89d+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_89b!=_898){
opts.onChange.call(_897,_898,_89b);
}
};
function _885(_89e){
var opts=$.data(_89e,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_896(_89e,opts.value);
opts.onChange=fn;
};
function _89c(_89f,_8a0){
var _8a1=$.data(_89f,"slider");
var opts=_8a1.options;
var _8a2=_8a1.slider;
if(opts.mode=="h"){
var pos=(_8a0-opts.min)/(opts.max-opts.min)*_8a2.width();
if(opts.reversed){
pos=_8a2.width()-pos;
}
}else{
var pos=_8a2.height()-(_8a0-opts.min)/(opts.max-opts.min)*_8a2.height();
if(opts.reversed){
pos=_8a2.height()-pos;
}
}
...
function _8a3(_8a4,pos){
var _8a5=$.data(_8a4,"slider");
var opts=_8a5.options;
var _8a6=_8a5.slider;
if(opts.mode=="h"){
var _8a7=opts.min+(opts.max-opts.min)*(pos/_8a6.width());
}else{
var _8a7=opts.min+(opts.max-opts.min)*((_8a6.height()-pos)/_8a6.height());
}
return opts.reversed?opts.max-_8a7.toFixed(0):_8a7.toFixed(0);
};
$.fn.slider=function(_8a8,_8a9){
if(typeof _8a8=="string"){
return $.fn.slider.methods[_8a8](this,_8a9);
}
_8a8=_8a8||{};
return this.each(function(){
var _8aa=$.data(this,"slider");
if(_8aa){
$.extend(_8aa.options,_8a8);
}else{
_8aa=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_8a8),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_8ad){
var t=$(_8ad);
return $.extend({},$.parser.parseOptions(_8ad,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_8ae){
return _8ae;
},onChange:function(_8af,_8b0){
},onSlideStart:function(_8b1){
},onSlideEnd:function(_8b2){
}};
})(jQuery);
